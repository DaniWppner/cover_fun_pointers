...
These steps will assume you're working on an appriopate kernel version, like
kernel version 6.10.0 with this repo's [kcov patch](./0001-kcov-add-support-for-fsanitize-coverage-trace-functi.patch) applied.

## 0. Build custom clang following the appropiate [README.md](../build_llvm/README.md)
